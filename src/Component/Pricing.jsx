...
const Pricing = () => {
  return (
    ...
    >
     <span className="bg-gray-700 text-white px-4 py-1 rounded-full text-sm font-medium ml-20">PRICING</span>
  <h2 className="text-4xl font-bold mb-6 mt-5 ml-20 overflow-hidden whitespace-nowrap">Your investment</h2>
  <div className="flex justify-center space-x-4">

    <div className="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col items-center mr-20">
      ...
      <ul className="mt-6 space-y-2 mr-10">
