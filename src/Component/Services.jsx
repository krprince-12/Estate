...
const Services = () => {
  return (
    ...
    >
      <div className='w-full border border-gray-800 rounded-xl mt-12 bg-gray-800/20 py-20'>
        <div className="text-center">
          <span className="bg-gray-700 text-white px-4 py-1 rounded-full text-sm font-medium">SERVICES</span>
          <h2 className="text-4xl font-bold mt-6">What our clients get</h2>
        </div>
