...
const Comparison = () => {
  return (
    ...
    >
      <div className="bg-gray-900 text-white p-6 rounded-lg shadow-lg border border-gray-800 w-full max-w-4xl mt-10">
        <span className="bg-gray-700 text-white px-4 py-1 rounded-full text-sm font-medium">COMPARISON</span>
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 mt-5 text-center">How do we compare?</h2>
